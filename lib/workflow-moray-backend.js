...
var WorkflowMorayBackend = module.exports = function (config) {
    ...
    function _createWfWorkflowsBucket(next) {
    ...
    function _createWfJobsBucket(next) {
    ...
    function _createWfRunnersBucket(next) {
    ...
    function _createWfJobsInfoBucket(next) {
    ...
    function _createBuckets(callback) {
        var series = {
            wf_workflows: _createWfWorkflowsBucket,
            wf_jobs: _createWfJobsBucket,
            wf_runners: _createWfRunnersBucket,
            wf_jobs_info: _createWfJobsInfoBucket
        };
    ...
    function init(callback) {
        ...
        client.on('connectAttempt', function (moray, number, delay) {
            log.info({
                attempt: number,
                delay: delay,
                moray: moray.toString()
    ...
    function validateJobTarget(job, callback) {
        ...
        var onRecord = function (obj) {
            ...
            try {
                if (val.params &&
                    _areParamsEqual(job.params, JSON.parse(val.params))) {
                    is_dup = true;
                }
            } catch (e) {
